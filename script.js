(() => {
    ...
    const config = {
        ...
        dotMaxRad:20,
        massFactor: 0.002,
        defaultColor:`rgb(240, 122, 38, 0.9)`,
        smooth: 0.65,
        sphereRadius:300,
        bigDotRad :35,
        mouseSize:120
    ...
    class Dot {
        constructor(radius) {
            ...
            this.vel = {x:0, y:0};
            this.rad = radius || random(config.dotMinRad, config.dotMaxRad);
    ...
    cnv.addEventListener(`mousemove`, setPos);
